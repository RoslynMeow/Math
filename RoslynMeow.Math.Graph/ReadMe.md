...
- 其他项目
  ...
  - `Bit/`、`RoslynMeow.Math.Fraction/` 等为工作区中的其他数学工具库项目。
...
- 抛出 `RoslynMeow.Math.Graph.Error.GraphMethodNotApplicableException`，异常包含 `MethodName`、`Reason`、`GraphSummary`，便于诊断。
